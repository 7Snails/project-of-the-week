...
document.write("<div id='about' class='w3-modal'> <div class='w3-modal-content'> <div class='w3-container'> <span onclick='document.getElementById('about').style.display='none'' class='w3-button w3-display-topright'>&times;</span> <p>Some text in the Modal..</p> <p>Some text in the Modal..</p> </div> </div> </div>");
